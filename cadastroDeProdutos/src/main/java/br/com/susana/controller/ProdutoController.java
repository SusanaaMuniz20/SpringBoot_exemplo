package br.com.susana.controller;
...
import br.com.susana.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public List<Produto> listarProdutos() {
		/*Produto p1 = new Produto("Celular Samsung", 35, 1299.99);
		Produto p2 = new Produto("Cafeteira Mundial", 10, 199.99);
		Produto p3 = new Produto("Mouse sem fio", 15, 9.95);
	...
	@GetMapping("/{id}")
	public ResponseEntity<Produto> findBynId(@PathVariable Long id) {
